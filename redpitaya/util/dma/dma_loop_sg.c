...
#define	SG_DMA_DESCRIPTORS_WIDTH           0xFFF
#define	MEMBLOCK_WIDTH                     0xFFFF  		//size of mem used by s2mm and mm2s
#define	BUFFER_BLOCK_WIDTH                 0x1000		//size of memory block per descriptor in bytes
#define	NUM_OF_DESCRIPTORS                 0x7		//number of descriptors for each direction

#define	HP0_DMA_BUFFER_MEM_ADDRESS         0x1000000
...
#define S2MM_TAILDESC_MSB           0x44    // unused with 32bit addresses
	...
	mm2s_descriptor_register_mmap[0x18 >> 2] = 0x8000000+BUFFER_BLOCK_WIDTH; // set mm2s/s2mm buffer length to control register

	mm2s_descriptor_register_mmap[0x40 >> 2] = HP0_MM2S_DMA_DESCRIPTORS_ADDRESS + 0x80; // set next descriptor address
	mm2s_descriptor_register_mmap[0x48 >> 2] = HP0_MM2S_SOURCE_MEM_ADDRESS + BUFFER_BLOCK_WIDTH; // set target buffer address
	mm2s_descriptor_register_mmap[0x58 >> 2] = BUFFER_BLOCK_WIDTH; // set mm2s/s2mm buffer length to control register

	mm2s_descriptor_register_mmap[0x80 >> 2] = HP0_MM2S_DMA_DESCRIPTORS_ADDRESS + 0xC0; // set next descriptor address
	mm2s_descriptor_register_mmap[0x88 >> 2] = HP0_MM2S_SOURCE_MEM_ADDRESS + BUFFER_BLOCK_WIDTH*2; // set target buffer address
	mm2s_descriptor_register_mmap[0x98 >> 2] = BUFFER_BLOCK_WIDTH; // set mm2s/s2mm buffer length to control register

	mm2s_descriptor_register_mmap[0xC0 >> 2] = HP0_MM2S_DMA_DESCRIPTORS_ADDRESS + 0x100; // set next descriptor address
	mm2s_descriptor_register_mmap[0xC8 >> 2] = HP0_MM2S_SOURCE_MEM_ADDRESS + BUFFER_BLOCK_WIDTH*3; // set target buffer address
	mm2s_descriptor_register_mmap[0xD8 >> 2] = BUFFER_BLOCK_WIDTH; // set mm2s/s2mm buffer length to control register

	mm2s_descriptor_register_mmap[0x100 >> 2] = HP0_MM2S_DMA_DESCRIPTORS_ADDRESS + 0x140; // set next descriptor address
	mm2s_descriptor_register_mmap[0x108 >> 2] = HP0_MM2S_SOURCE_MEM_ADDRESS + BUFFER_BLOCK_WIDTH*4; // set target buffer address
	mm2s_descriptor_register_mmap[0x118 >> 2] = BUFFER_BLOCK_WIDTH; // set mm2s/s2mm buffer length to control register

	mm2s_descriptor_register_mmap[0x140 >> 2] = HP0_MM2S_DMA_DESCRIPTORS_ADDRESS + 0x180; // set next descriptor address
	mm2s_descriptor_register_mmap[0x148 >> 2] = HP0_MM2S_SOURCE_MEM_ADDRESS + BUFFER_BLOCK_WIDTH*5; // set target buffer address
	mm2s_descriptor_register_mmap[0x158 >> 2] = BUFFER_BLOCK_WIDTH; // set mm2s/s2mm buffer length to control register

	mm2s_descriptor_register_mmap[0x180 >> 2] = 0x00; // set next descriptor address (unused?)
	mm2s_descriptor_register_mmap[0x188 >> 2] = HP0_MM2S_SOURCE_MEM_ADDRESS + BUFFER_BLOCK_WIDTH*6; // set target buffer address
	mm2s_descriptor_register_mmap[0x198 >> 2] = 0x4000000+BUFFER_BLOCK_WIDTH; // set mm2s/s2mm buffer length to control register
	...
	s2mm_descriptor_register_mmap[0x18 >> 2] = 0x8000000+BUFFER_BLOCK_WIDTH; // set mm2s/s2mm buffer length to control register

	s2mm_descriptor_register_mmap[0x40 >> 2] = HP0_S2MM_DMA_DESCRIPTORS_ADDRESS + 0x80; // set next descriptor address
	s2mm_descriptor_register_mmap[0x48 >> 2] = HP0_S2MM_TARGET_MEM_ADDRESS + BUFFER_BLOCK_WIDTH; // set target buffer address
	s2mm_descriptor_register_mmap[0x58 >> 2] = BUFFER_BLOCK_WIDTH; // set mm2s/s2mm buffer length to control register
	...
	s2mm_descriptor_register_mmap[0x98 >> 2] = BUFFER_BLOCK_WIDTH; // set mm2s/s2mm buffer length to control register
	...
	s2mm_descriptor_register_mmap[0xD8 >> 2] = BUFFER_BLOCK_WIDTH; // set mm2s/s2mm buffer length to control register
	...
	s2mm_descriptor_register_mmap[0x118 >> 2] = BUFFER_BLOCK_WIDTH; // set mm2s/s2mm buffer length to control register
	...
	s2mm_descriptor_register_mmap[0x158 >> 2] = BUFFER_BLOCK_WIDTH; // set mm2s/s2mm buffer length to control register
	...
	s2mm_descriptor_register_mmap[0x198 >> 2] = 0x4000000+BUFFER_BLOCK_WIDTH; // set mm2s/s2mm buffer length to control register
